...
func newSettingsService(db settingsStore, cfg *config.Config, defaultSessionLifetime time.Duration) *settingsService {
	...
	s.def = SettingsView{
		...
		AllowPrivateNetworkHTTPRedirect: cfg.Security.AllowPrivateNetworkHTTPRedirect,
...
func viewFromModel(m *model.Settings, def SettingsView) SettingsView {
	return SettingsView{
		...
		AllowPrivateNetworkHTTPRedirect: m.AllowPrivateNetworkHTTPRedirect,
...
func (v SettingsView) toModel() *model.Settings {
	return &model.Settings{
		...
		AllowPrivateNetworkHTTPRedirect: v.AllowPrivateNetworkHTTPRedirect,
