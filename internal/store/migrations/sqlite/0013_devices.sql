...
VALUES ('omni-enrollment', '', 'Omni Enrollment', '[]', '["openid","profile","email","offline_access","device:enroll"]', 'public', 0,
        CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'Omni Enrollment', '', '', '[]', 0);
